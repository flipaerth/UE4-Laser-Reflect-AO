...
#define UE_PROJECT_NAME LaserReflectAO
#define UE_TARGET_NAME LaserReflectAOEditor
#define UE_MODULE_NAME "LaserReflectAO"
...
#define LASERREFLECTAO_API DLLEXPORT
